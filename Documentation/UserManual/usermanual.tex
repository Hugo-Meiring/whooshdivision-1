...
Lastly, in order to specify where the viewer should start their scene, the following is used:
\begin{itemize}
\item Viewer: this is used to determine the starting position and direction of the viewer in the scene.
\end{itemize}
...
\textbf{Model,EntityLink,http://EntityFile.obj,posX,posY,posZ,lenX,lenY,lenZ}

The line above imports a model into the scene. The model will be black by default.
...
\textbf{lenX:} The X length of the Model.\\
\textbf{lenY:} The Y length of the Model.\\
\textbf{lenZ:} The Z length of the Model.\\

\subsubsection{Colour}

\textbf{Colour,EntityLink,colourName,\#colour}

This is the format of input to change an Entity's colour. This entity can either be a shape or a model.
...
\textbf{Viewer,xPos,yPos,zPos,yRotation}

This is used to determine the starting position and direction of the viewer in the scene.

\textbf{Viewer:} This specifies the type of action being done. This value never changes when dealing with the single viewer camera.\\
\textbf{Pos:} These are used to plot the point where the viewer will be placed.\\
\textbf{yRotation:} The rotation of the camera around the y-axis. This will determine the direction the camera is facing initially.
