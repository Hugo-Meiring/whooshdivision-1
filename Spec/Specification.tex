...
Developing for VR we are choosing to use a game engine. Game engines are great since they offer almost all technologies to be used in a single package. Our game engine of choice is currently Unreal Engine 4 (UE4).\newline\newline UE4 provides cross platform support for Windows, Linux and Mac. It also has built in support for VR specifically for Oculus Rift headset which is going to be used.\newline\newline We will use Oculus Rift's Unreal engine integration.   
