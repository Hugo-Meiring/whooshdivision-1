...
\begin{enumerate}
	\item \textbf{Game engine:}\\
		...
		\begin{enumerate}
			...
			\item \textbf{CryEngine:} CryEngine is designed more for experienced game developers and people used to graphics with years of experience. %to complete, why choose unreal rather than cryengine?
		\end{enumerate}
\end{enumerate}
